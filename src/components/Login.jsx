  ...
  return (
    ...
    >
      <form
        ...
        className="flex flex-col gap-4 m-auto items-start p-6 w-80 sm:w-[352px] rounded-lg shadow-xl border border-gray-200 bg-white"
      >
        <div className="flex justify-center w-full">
          <img src={assets.logo} alt="logo" className='w-48 mb-1' />
        </div>
